...
export const reviews = [
  {
    ...
    rating: 5,
    review:
      "Rant-Coffee has completely changed my morning routine. The coffee quality is amazing and every cup feels special.",
  },
  {
    id: 2,
    name: "Michael Smith",
    ...
    rating: 5,
    review:
      "The flavor, aroma, and service are outstanding. Their caramel latte is one of the best coffees I have ever tried.",
  },
  {
    id: 3,
    name: "Emily Brown",
    ...
    rating: 4,
    review:
      "Amazing experience! Fresh coffee, friendly service, and a beautiful atmosphere. Highly recommended.",
  },
];